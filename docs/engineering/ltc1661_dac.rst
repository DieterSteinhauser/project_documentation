...
rising edge of the clock.  The maximum baud rate of the LTC1661 is 10MHz [1]_.

.. figure:: theremin_images/image008.png
  :align: center

  Figure 1: Timing Diagram of LTC1661 SPI communication [1]_
...
would be applicable for continuously changing voltage on output A and B respectively [1]_

.. figure:: theremin_images/image009.png
  :align: center

  Figure 2: SPI communication Sequence for the LTC1661 [1]_.
