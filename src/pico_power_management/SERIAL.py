...
# Serial Helpers
# Sends data over built-in serial USB
...
def send_serial_data(sys, id_value, value):
    """
...
def tx_serial_rail_data(sys, mux1 = None, mux2 = None, mux3 = None, mux4 = None):
    """
    ...
    for mux in mux_set: # iterate through each dictionary.
        ...
        if mux is not None and len(mux) > 0:
            ...
            for value in mux.values(): # Iterate through each value, send the data and index the base ID.
                ...
                # Send the UART Data
                send_serial_data(sys, base_id, value) 


def tx_serial_bms_data(sys, bms_dict):
    """
